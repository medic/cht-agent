...
const displayIssueDetails = (ticket: IssueTemplate) => {
...
const displayResearchFindings = (result: ResearchState) => {
...
const displayContextAnalysis = (result: ResearchState) => {
...
const displayPlanPhases = (plan: OrchestrationPlan) => {
...
const displayOrchestrationPlan = (result: ResearchState) => {
...
const displayResults = (result: ResearchState, duration: string) => {
  console.log('\n╔════════════════════════════════════════════════════════════════╗');
