 ...
 * itself starts with a CHT `type(#N):` conventional-commit prefix encoded as
 * `type<n>-...` (e.g. `10043-feat10036-add-thing.md` -> 10036). Returns null
 * when the slug carries no unambiguous issue token.
 */
